...
function convertNumberToString(numberStr) {
  ...
  for (let i = 0; i <= String(numberStr).length; i += 1) {
    if (i === 0) {
      switch (String(numberStr[i])) {
        case '.':
          stringify = `${stringify}point`;
          break;
        case ',':
          stringify = `${stringify}point`;
          break;
        case '-':
          stringify = `${stringify}minus`;
          break;
        case '0':
          stringify = `${stringify}zero`;
          break;
        case '1':
          stringify = `${stringify}one`;
          break;
        case '2':
          stringify = `${stringify}two`;
          break;
        case '3':
          stringify = `${stringify}three`;
          break;
        case '4':
          stringify = `${stringify}four`;
          break;
        case '5':
          stringify = `${stringify}five`;
          break;
        case '6':
          stringify = `${stringify}six`;
          break;
        case '7':
          stringify = `${stringify}seven`;
          break;
        case '8':
          stringify = `${stringify}eight`;
          break;
        case '9':
          stringify = `${stringify}nine`;
          break;
        default:
          stringify = `${stringify}`;
      }
...
function getBalanceIndex(arr) {
  ...
  function sumRight(arr2, n, index) {
    let sum = 0;
  ...
  const n = arr.length;
  for (let i = 0; i < n; i += 1) {
    const suml = sumLeft(arr, n, i);
    const sumr = sumRight(arr, n, i);
    if (suml === sumr) {
      index3 = i;
    }
  }
